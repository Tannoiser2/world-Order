...
- 🟡 **Turno guidato dalla UI**: INDICATORI più chiari fatti (v0.7.53): HUD con Round/Fase/«▶ POTENZA» nel colore di turno, ▶ sulla linguetta attiva, prompt azioni a inizio turno. Resta opzionale un handoff hot‑seat completo (schermata «passa il dispositivo») se servirà.
